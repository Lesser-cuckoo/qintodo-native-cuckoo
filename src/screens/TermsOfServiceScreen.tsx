      ...
      <View style={tw`flex-1 justify-center items-center bg-white `}>
        <ScrollView>
          <Text>
            ...
            前各号以外で、本サービスが不適切な利用であると判断する場合 第２条
            登録情報
            ...
            法令又は公序良俗に反する行為 犯罪行為の全部又は一部をなす行為
            ...
            第１６条 準拠法・裁判管轄 本規約は、日本法に従って解釈されます。
